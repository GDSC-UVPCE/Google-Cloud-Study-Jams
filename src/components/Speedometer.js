    ...
    return (
        <div className=" relative w-full flex justify-center items-center">
            <div className="relative w-40 h-40 rounded-full bg-gray-400 flex justify-center items-center overflow-hidden">
                ...
                <svg className='absolute z-10 w-40 h-20 -left-0 bottom-5 rotate-[80deg]   flex justify-center items-center text-center' viewBox="0 0 528 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <ellipse cx="293.173" cy="26" rx="27.7187" ry="26" fill="black" />
                    <path d="M0.0830078 25.4737L396.021 13.3493V37.598L0.0830078 25.4737Z" fill="#1B0707" />
            ...
            <div className="absolute -bottom-5 w-60 h-20 bg-white rounded-t-full text-center font-semibold px-5 pt-10 text-green-500">
                <p className="bottom-0">  {
                    completion > 40 ?
                        completion > 60 ?
                            completion > 80 ? "Outstanding" : 'Level 1'
                            : 'Level 2'
                        : 'Level 3'
